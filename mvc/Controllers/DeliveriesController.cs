...
namespace MVC.Controllers
{
    public class DeliveriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DeliveryID,DeliveryDate,LastOrderDate,Delivered")] Delivery delivery)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DeliveryID,DeliveryDate,LastOrderDate,Delivered")] Delivery delivery)
        {
